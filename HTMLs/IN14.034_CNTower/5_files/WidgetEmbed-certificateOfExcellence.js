...
window.taAddValidator (injectcertificateOfExcellence926)

                  if(document.createStyleSheet) {
        document.createStyleSheet("https://static.tacdn.com/css2/build/concat/t4b_widget_coe-v21395434625a.css");
      } else {
        var newSS=document.createElement('link');
        newSS.rel='stylesheet';
        newSS.href='https://static.tacdn.com/css2/build/concat/t4b_widget_coe-v21395434625a.css';
...
function injectcertificateOfExcellence926() {
    var container = document.getElementById('TA_certificateOfExcellence855');
  if (container == null) {
        var scriptTags = document.getElementsByTagName("script");
    for (var i=0; i<scriptTags.length; i++)
    {
      if (scriptTags[i] != null && scriptTags[i].src != null &&
          scriptTags[i].src.indexOf("certificateOfExcellence?uniq=855") >= 0)
      {
  ...
  holderElement.innerHTML = '<iframe style="height:0;width:0;display:none;" src="https://p.travelsmarter.net/api/usersync/sync.html?api_key=TxLExUPOSpaM-4SJwXvYmQ&publisher_browser_id=8ee66abe1c253aeafb4a4e6ba176025908e63d0f&cb=1571695663595"></iframe> '+
'<div id="CDSWIDCOE" class="widCOE"> '+
'<div class="widCOETitle"> '+
'Certificate of Excellence </div> '+
'<div class="widCOEDate"> '+
'<span class="widCOEDateText">2019</span> </div> '+
'<div class="widCOELogo"> '+
'<a target="_blank" href="https://www.tripadvisor.ca/Restaurant_Review-g155019-d681795-Reviews-360_The_Restaurant_at_the_CN_Tower-Toronto_Ontario.html"><img src="https://www.tripadvisor.ca/img/cdsi/img2/awards/CoE2017_WidgetAsset-14348-2.png" alt="TripAdvisor" class="widCOEImg" id="CDSWIDCOELOGO"/></a> '+
'</div> '+
'</div><!--/ #CDSWIDCOE--> '+
'';
  ...
  if (links) {
    ...
    var widgetHtml = '<iframe style="height:0;width:0;display:none;" src="https://p.travelsmarter.net/api/usersync/sync.html?api_key=TxLExUPOSpaM-4SJwXvYmQ&publisher_browser_id=8ee66abe1c253aeafb4a4e6ba176025908e63d0f&cb=1571695663595"></iframe> '+
'<div id="CDSWIDCOE" class="widCOE"> '+
'<div class="widCOETitle"> '+
'Certificate of Excellence </div> '+
'<div class="widCOEDate"> '+
