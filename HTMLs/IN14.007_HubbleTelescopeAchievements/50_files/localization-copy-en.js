define(function(){
	...
	return {
		...
		search: {
			...
			pointcastlbl : "Enter a Canadian Postal Code or US ZIP Code for weather forecasts within 1 km.",
			pointcastlbl_responsive : "Enter a Postal Code or ZIP Code for weather forecasts within 1 km",
			txt_pointcast_input : "Enter a Canadian POSTAL code/ US ZIP code or location name",
			golf: "Golf Report",
			countries : "Countries",
			ski : "Ski Resorts",
			schools : "Schools",
		...
		notifications:{
			...
			moredetails_label:"More details",
			url_myalerts_manage:"/my-account/my-alerts"
		},
		maps: {
			//loading:"Loading",
			wait:"Please wait ...",
			...
			site_prefix: "twn",
			bounding_box_factor: ".",
			url_ushwy_short_term: "/us-highway-weather-forecast/short-term",
			...
			lght_sngl:" lightning strike at",
			lght_mult:" lightning strikes; most recent strike at",
			satrad:{
		...
		signin: {
			url_login:"/my-account/login",
			url_sign_in:"/my-account/sign-in",
			url_sign_up:"/my-account/sign-up",			
			lbl_signin:"Sign in",
		...
		charts: {
			...
			lasttwentyfour_tab:"Last 24 Hrs",
		...
		page_url: {
			weather_url: "weather",
			cottage_url: "forecasts/cottage",
			camping_url: "forecasts/camping",
			beaches_url: "forecasts/beaches",
			attractions_url: "forecasts/attractions",
			golf_url: "forecasts/golf-report",
			school_url: "forecasts/school-day",
			...
			url_news_category_latest: "/news/category/latest",
			url_insider_insights: "insider-insights",
			url_poll: "poll",
			url_news_releases: "/pressroom",
			url_upload: "/my-account/upload",
			url_edit_account: "/my-account/edit-account",
			url_edit_locations: "/edit-locations",
			url_myaccount_edit_locations: "/my-account/edit-locations",
			url_my_account: "/my-account",
			url_my_profile: "/my-account",
			url_account_manage: "/my-account/manage",
			url_manage: "/manage",
			url_my_alerts:"/my-account/my-alerts",
			url_myalerts_manage:"/my-account/my-alerts",
			hourly_url: "hourly-weather-forecast",
			day_7_url: "7-day-weather-forecast",
			hour_36_url: "36-hour-weather-forecast",
			day_14_url: "14-day-weather-trend",
			weekend_url: "weekend-weather-forecast",
			url_eu_privacy_policy: "https://www.theweathernetwork.com/uk/about-us/privacy-policy"
		},
		survey: {
			csat_url: "",
			roundtable_url: ""
		...
		myaccount:{		
			...
			txt_user_does_not_exist:"User does not exists",
			...
			txt_invalid_credentials_msg:"The email address or password is incorrect. Please try again or <a id='btn_create_acct' href='/my-account/sign-up' target='_top' >click here</a> to create an account.",
			...
			txt_each_link_used_once_lr:"Each link can only be used once, you can login now if you have already verified the email.",
			txt_social_edit_profile:"Be prepared, stay safe and plan your day with weather information and weather alerts delivered straight to you.",
			txt_sign_up_check_email_message: "Almost there! Please check your inbox for an email from The Weather Network and click on the link to verify your account . The link is valid for 72 hours from the time the email is delivered.",
			txt_account_already_exist_message:"It seems you already have an account. It’s possible you have signed in previously with your social account. <a href='/my-account/sign-in'>Sign in</a> or <a href='/my-account/reset-password'>Forgot Password</a>?",
			...
			txt_no_na_locations_message:"Please save cities (Canadian and American) and then subscribe for alerts.",
		...
		contactus: {
			...
			error_provider: "Please enter your provider",
			error_signaltype: "",
