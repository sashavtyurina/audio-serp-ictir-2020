...
(function ($, Drupal) {
  ...
  // Drupal.behaviors.termsDownloadLinks = {
  //   attach: function (context, settings) {
  //     $('.glossary-download').on('click', function() {
  //       var downloadOptions = $('.download-options', context);
  //       if (downloadOptions.hasClass('active')) {
  //         downloadOptions.removeClass('active');
  //       }
  //       else {
  //         downloadOptions.addClass('active');
  //       }
  //     });
  //   }
  // };
