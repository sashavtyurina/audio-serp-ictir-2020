...
// Created: 11/30/2012 6:33:43 PM

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid="dcs4zxlja10000sxcmlgunoe0_6k3y";
	this.domain="www8.bchydro.com";
	this.timezone=-8;
	this.onsitedoms="bchydro.com";
	this.downloadtypes="xls,doc,pdf,csv,zip,docx,xlsx";
